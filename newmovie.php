<?php
  ...
  $userData = $userDao->verifyToken(true); // autenticação do usuário, não permite usuario deslogados

?>

<!-- -->
  <div id="main-container" class="container-fluid">
    <div class="offset-md-4 col-md-4 new-movie-container"><!-- offset = deslocamento -->
