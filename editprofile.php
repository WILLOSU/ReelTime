<?php
  ...
  if($userData->image == "") { // condição para a imagem padrão
...
?>
  <div id="main-container" class="container-fluid edit-profile-page">
    <div class="col-md-12">
      ...
      <!-- Profile de edição -->
      <form action="<?= $BASE_URL ?>user_process.php" method="POST" enctype="multipart/form-data"> <!-- usar multpart para enviar imagem-->
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="form-group">
              <label for="email">E-mail:</label> <!-- USAR readonly (não edita), disable não envia dados para backend -->
            ...
            <!-- coluna da imagem, tag div para aceitar qualquer imagem -->
          </div>
          <div class="col-md-4">
            <div id="profile-image-container" style="background-image: url('<?= $BASE_URL ?>img/users/<?= $userData->image ?>')"></div>
            <div class="form-group">
              <label for="image">Foto:</label>
              <input type="file" class="form-control-file" name="image"> <!-- buscar imagem -->
            </div>
